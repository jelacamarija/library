...
public interface ClientRepository extends JpaRepository<Client,Long> {
    ...
    @Query("SELECT c FROM Client c WHERE c.membershipNumber = :membershipNumber")
    Optional<Client> findByMembershipNumber(@Param("membershipNumber") String membershipNumber);
